...
The tool presented in this work aims to support the developer during debugging by visualizing data in a graphic way and thus eliminating the cognitive effort needed to parse and interpret text based logging messages.
While most of the currently available visualization tools in robotics focus on spacial data to help understand the robot and the environment in which it runs \cite{Collett2010, Collett2007, Collett2006, Quigley2009}, rendering of abstract data is still uncommon. This paper presents a tool to visualize abstract data to support the developer with problem detection and debugging.
