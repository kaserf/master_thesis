...
[what visualization tools are there? name playerv, rviz, ardev]
...
The problem with 3d visualization tools is that abstract data often does not fit into the 3-dimensional rendering and in case of augmented reality can hide important information from the real world \cite{Collett2010}.
