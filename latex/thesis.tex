...
% set spacing in chapter and section titles to single space
\usepackage{titlesec}

\titleformat{\chapter}%\normalfont\Large\bfseries
{\onehalfspacing\Huge\sf\bfseries}{\thechapter}{1em}{}%{\thesection}{1em}{}
%\titleformat{\section}
%{\onehalfspacing\Large\sf\bfseries}{\thesection}{1em}{}
%\titleformat{\subsection}
%{\onehalfspacing\large\sf\bfseries}{\thesubsection}{1em}{}
%\titleformat{\subsubsection}
%{\onehalfspacing\sf\bfseries}{\thesubsubsection}{1em}{}
