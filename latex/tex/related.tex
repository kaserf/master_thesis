...
\todo{review and update once ROS is settled}
...
This section presents the logging facilities in ROS, which is similar to many other logging frameworks not only in robotics. Other popular logging frameworks are Apache's Log4j\footnote{\url{http://logging.apache.org/log4j}} for Java and log4cxx\footnote{\url{http://logging.apache.org/log4cxx/}} for C++. The last part of this section presents the most basic form of logging: print statements.

\todo{Should I go into more detail with log4j and log4cxx?}

\subsection{Logging in ROS}
\label{ros_logging}

%The Robot Operating System (ROS) is a framework to develop robotic applications. It offers a communication middleware which can be used to communicate between the various modules of a robot.
\todo{ROS has not been introduced here yet, the first appearance of ROS is in the rosdashboard chapter. Maybe introduce it at the very beginning of this chapter?}
