...
This section presents the logging facilities in ROS, which is similar to many other logging frameworks not only in robotics. Other popular logging frameworks are Apache's Log4j\footnote{\url{http://logging.apache.org/log4j}} for Java and log4cxx\footnote{\url{http://logging.apache.org/log4cxx/}} for C++. This section also presents the most basic form of logging: print statements.
